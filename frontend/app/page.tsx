      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            ...
            <a href="#conferences" onClick={() => setMobileMenuOpen(false)} className="py-2 border-b border-white/5 text-gray-300 hover:text-accent-blue hover:border-accent-blue/40 font-semibold text-xs tracking-wider transition-colors">SCHEDULE</a>
                ...
                <div>
                  ...
                  <div className="mb-6 p-3 bg-black/50 rounded-xl border border-accent-blue/20">
                    <div className="text-2xl font-black text-accent-blue tracking-tight">
                      {tier.priceUSD} <span className="text-sm">USD</span>
                    </div>
                    <div className="text-xs text-gray-400 font-mono mt-0.5">
                      or <span className="text-white font-semibold">{tier.priceINR}</span> INR
                    </div>
                  </div>
                        ...
                        {sponsorshipTiers.map((tier) => (
                          ...
                          >
                            ...
                            <div className="text-[11px] font-mono text-accent-blue mt-1 font-bold">
                              {tier.priceUSD} USD <span className="text-gray-400 font-normal">({tier.priceINR} INR)</span>
                            </div>
                          </div>
                        ))}
                      </div>
