...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0D1117] flex font-sans antialiased selection:bg-blue-100 selection:text-[#1E40AF]">
      {/* Sidebar Navigation */}
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/90 backdrop-blur-md border-b border-[#1E40AF]/15 px-6 flex items-center justify-between gap-4 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="flex items-center gap-2.5 p-1.5 pr-3 rounded-xl bg-slate-100 border border-slate-300 hover:border-[#1E40AF]/40 transition-colors shadow-xs"
            >
              ...
              <span className="text-xs font-bold text-slate-800 hidden md:inline">Admin</span>
            </Link>
          </div>
        </header>
