    ...
    <AdminLayout>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-700 font-medium">Configure payment gateway keys, SMTP email credentials, and platform defaults</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-white border border-[#1E40AF]/15 shadow-sm space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-xs font-extrabold text-[#0D1117] block mb-2 font-mono">Razorpay Key ID</label>
              <input
                type="password"
            ...
            <div>
              <label className="text-xs font-extrabold text-[#0D1117] block mb-2 font-mono">Stripe Publishable Key</label>
              <input
                type="password"
        ...
        <div className="space-y-4 pt-4 border-t border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-xs font-extrabold text-[#0D1117] block mb-2">SMTP Host</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-xs font-extrabold text-[#0D1117] block mb-2">SMTP Port</label>
              <input
                type="text"
