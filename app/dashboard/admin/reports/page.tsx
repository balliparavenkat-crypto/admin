    ...
    <AdminLayout>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-700 font-medium">Export registration, paper submission, financial, and attendance data into CSV / Excel format</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {[
          ...
          >
            ...
            <p className="text-xs text-slate-600 font-medium leading-relaxed">{rep.desc}</p>
          </div>
        ))}
      </div>
    </AdminLayout>
