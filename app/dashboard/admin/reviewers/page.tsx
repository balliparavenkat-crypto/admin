          ...
          <tbody className="divide-y divide-slate-200 text-slate-900 font-medium">
            {reviewers.map((r) => (
              <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                <td className="p-4 font-bold text-[#0D1117]">{r.name} <span className="block text-[10px] font-mono text-slate-600 font-bold">{r.email}</span></td>
                <td className="p-4 font-bold text-slate-800">{r.institution}</td>
